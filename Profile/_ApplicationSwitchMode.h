...
#ifndef _ApplicationSwitchMode_H
#define _ApplicationSwitchMode_H
...
/* Forward declaration of the class Application::SwitchMode */
#ifndef _ApplicationSwitchMode_
  EW_DECLARE_CLASS( ApplicationSwitchMode )
#define _ApplicationSwitchMode_
#endif
...
/* Deklaration of class : 'Application::SwitchMode' */
EW_DEFINE_FIELDS( ApplicationSwitchMode, CoreGroup )
  ...
  EW_OBJECT  ( TouchTimer,      CoreTimer )
  EW_OBJECT  ( Image1,          ViewsImage )
EW_END_OF_FIELDS( ApplicationSwitchMode )

/* Virtual Method Table (VMT) for the class : 'Application::SwitchMode' */
EW_DEFINE_METHODS( ApplicationSwitchMode, CoreGroup )
  ...
  EW_METHOD( Add,               void )( CoreGroup _this, CoreView aView, XInt32 
    aOrder )
EW_END_OF_METHODS( ApplicationSwitchMode )
...
#endif /* _ApplicationSwitchMode_H */
